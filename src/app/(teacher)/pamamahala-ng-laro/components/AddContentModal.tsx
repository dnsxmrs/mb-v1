    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (gameType === 'word-search') {
            ...
            try {
                ...
                if (result.success) {
                    toast.success(result.message || 'Matagumpay na nagawa ang word search!')
                    onSuccess?.()
                } else {
                    toast.error(result.error || 'Hindi magawa ang word search')
                }
            } catch (error) {
                console.error('Error submitting form:', error)
                toast.error('May hindi inaasahang error na naganap')
            } finally {
                setIsLoading(false)
            }
        } else {
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-120px)]">
                    <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ilagay ang pamagat ng word search"
                                        maxLength={250}
                                    />
                                </div>
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="text-black w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        placeholder="Ilagay ang paglalarawan ng word search"
                                        rows={3}
                                        maxLength={250}
                                    />
                                </div>
                                <div>
                                    ...
                                    >
                                        <option value="active">Aktibo (default)</option>
                                    </select>
                                </div>
                            </div>
                        )}
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-3">
                                    <label className="block text-sm font-medium text-black">
                                        Mga Salita <span className="text-red-500">*</span>
                                    </label>
                                </div>
                                    ...
                                    {formData.words.map((wordObj, index) => (
                                        <div key={index} className="border border-gray-300 rounded-lg p-4 space-y-3">
                                            <div className="flex justify-between items-center">
                                                <h4 className="font-medium text-black">Salita {index + 1}</h4>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="text-black w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                        placeholder="Ilagay ang paglalarawan ng salita (para sa TTS)"
                                                        maxLength={250}
                                                    />
                                                </div>
                                            </div>
                        ...
                        {gameType === 'mystery-box' && (
                            <div>
                                <div className="flex items-center justify-between mb-3">
                                    <label className="block text-sm font-medium text-black">
                                        Mga Item <span className="text-red-500">*</span>
                                    </label>
                                </div>
                                <div className="space-y-3">
                    ...
                    <div className="flex justify-end gap-3 p-6">
                        ...
                        >
                            {isLoading ? 'Ginagawa...' : 'Gumawa ng Nilalaman'}
                        </button>
                    </div>
                </form>
            </div>
